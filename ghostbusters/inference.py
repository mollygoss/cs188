...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:
            ...
            distribution[position] = probability * self.beliefs[position]
    ...
    def elapseTime(self, gameState):
        ...
        for position in self.allPositions:
            ...
            oldprob = self.beliefs[position]
            newdistribution = self.getPositionDistribution(gameState, position)

            for newposition, value in newdistribution.items():
                distribution[newposition] += oldprob * value
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        while i <= self.numParticles:
            self.particles.append(possible[i % len(possible)])
            i += 1
    ...
    def observeUpdate(self, observation, gameState):
        ...
        #case where all particles recieve zero weight
    ...
    def elapseTime(self, gameState):
        ...
        while i < len(self.particles):
            ...
            distribution[oldPos] = newPosDist
...
class JointParticleFilter(ParticleFilter):
    ...
    def initializeUniformly(self, gameState):
        ...
        while particles > len(permutations):
            self.particles += permutations
            particles-= len(permutations)

        self.particles += permutations[0:particles]
